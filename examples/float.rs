...
pub broadcast axiom fn f64_add_positive_spec(a: f64, b: f64)
    ...
    ensures
        ...
        af(done(!a.add_spec(b).is_nan_spec())),
        af(done(!a.add_spec(b).is_sign_negative_spec()));
...
pub broadcast axiom fn f64_add_positive_ensures(a: f64, b: f64, o: f64)
    requires
        ...
        !b.is_sign_negative_spec(),
    ensures
        af(done(#[trigger] add_ensures::<f64>(a, b, o) ==> o == a.add_spec(b)));
