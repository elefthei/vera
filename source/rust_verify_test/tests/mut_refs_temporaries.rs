...
test_verify_one_file_with_options! {
    #[test] temporary_place_ctor_update_tail ["new-mut-ref"] => verus_code! {
        ...
        fn mut_ref_pairs2<'a, 'b, 'c, 'd>(a: &'a mut u64, b: &'b mut u64, c: &'c mut u64, d: &'d mut u64) -> (ret: (Pair<&'a mut u64, &'b mut u64>, Pair<&'c mut u64, &'d mut u64>))
            ensures
                af(done(mut_ref_current(ret.0.a) == mut_ref_current(a))),
                af(done(mut_ref_future(ret.0.a) == mut_ref_future(a))),
                af(done(mut_ref_current(ret.0.b) == mut_ref_current(b))),
                af(done(mut_ref_future(ret.0.b) == mut_ref_future(b))),
                af(done(mut_ref_current(ret.1.a) == mut_ref_current(c))),
                af(done(mut_ref_future(ret.1.a) == mut_ref_future(c))),
                af(done(mut_ref_current(ret.1.b) == mut_ref_current(d))),
                af(done(mut_ref_future(ret.1.b) == mut_ref_future(d))),
        {
